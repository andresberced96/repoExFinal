...
function cargarInformacionUsuario(idUsuario)
{
    ...
    */
    ...
    .then(response => response.json())
    .then(data => {
        unUsuario = document.getElementById('unUsuario')
        nomUsuario = document.getElementById('nomUsuario')
        apeUsuario = document.getElementById('apeUsuario')
        correoUsuario = document.getElementById('correoUsuario')
        idUs = document.getElementById('idUsuario')

        profeUsuario = document.getElementById('profeUsuario')
        nCelular = document.getElementById('nCelular')
        perUsuario = document.getElementById('perUsuario') 
        ...
        unUsuario.value = data.uname
        nomUsuario.value = data.nUsuario
        apeUsuario.value = data.apUsuario
        correoUsuario.value = data.mailUsuario
        nCelular.value = data.celular
        profeUsuario.value = data.profesion
        perUsuario.value = data.perfil        
        idUs.value = String(idUsuario)
    })   
}